...
json block = {
    ...
    {"tx",
     {{{"txID", "aaaaaaaaa"},
       ...
       {"type", "notary"},
       {"content",
        {{"name", "kim"}, {"address", "seoul"}, {"tel", "01011111111"}}}},
      {{"txID", "bbbbbbbbb"},
       {"time", "123123123"},
       ...
       {"type", "notary"},
       {"content",
        {{"name", "lim"}, {"address", "incheon"}, {"tel", "01022222222"}}}},
      {{"txID", "ccccccccc"},
       {"time", "123123123"},
       {"rID", "sdoijus89ajw3djkawnejkfnaweu9ahvwnauine49afu48ja94jrawioejr"},
       {"rSig", "2e89wdnjwnkachwuhcawkjenaw7hrbwjkdndcozsncoizsncdzipsdnc2i"},
       {"type", "notary"},
       {"content",
        {{"name", "choi"}, {"address", "jeju"}, {"tel", "01033333333"}}}},
      {{"txID", "ddddddd"},
       {"time", "123123123"},
       {"rID", "sdoijus89ajw3djkawnejkfnaweu9ahvwnauine49afu48ja94jrawioejr"},
       {"rSig", "2e89wdnjwnkachwuhcawkjenaw7hrbwjkdndcozsncoizsncdzipsdnc2i"},
       {"type", "notary"},
       {"content",
        {{"name", "tom"}, {"address", "newyork"}, {"tel", "01044444444"}}}},
