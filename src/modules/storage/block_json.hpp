...
namespace gruut {
    ...
    json block = {
            {"block", {
                              ...
                              {"pbID", "b6f6991d03df0e2e04dafffcd6bc418aac66049e2cd74b80f14ac86db1e3f0da"},
                              {"prev", "00000000000007d0f98d9edca880a6c124e25095712df8952e0439ac7409738a"},
                              {"txCnt", "4"},
    ...
    const string BLKHASH = "oosdmkbjectTobinary";
}
#endif