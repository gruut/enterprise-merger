    ...
    private:
        ...
        public:
            ...
            CheckAlive(MergerCommunication::AsyncService *service, ServerCompletionQueue *cq)
                    : m_check_service(service), m_check_cq(cq), m_check_responder(&m_check_ctx), m_check_status(CREATE) {
            ...
            void proceed() {
                switch (m_check_status) {
                    case CREATE: {
                        ...
                        m_check_service->RequestcheckAlive(&m_check_ctx, &m_check_request, &m_check_responder, m_check_cq, m_check_cq, this);
                    }
                        break;
            ...
            void proceed() {
                switch (m_push_status) {
                    case CREATE: {
                        ...
                        m_push_service->RequestpushData(&m_push_ctx, &m_push_request, &m_push_responder, m_push_cq, m_push_cq, this);
                    }
                        break;
                    ...
                    case PROCESS: {
                        ...
                        //1. decompress data
                        //2. check json schema
                        //3. if  json schema is wrong  -> request "send data again" // bool message = false
                        //  else continue// bool message = true
            ...
            void proceed()
            {
                switch (m_pull_status) {
                    case CREATE: {
                        ...
                        m_pull_service->RequestpullData(&m_pull_ctx, &m_pull_request, &m_pull_responder, m_pull_cq, m_pull_cq, this);
                    }
                        break;
