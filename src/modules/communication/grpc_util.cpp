...
#include <cstring>
namespace gruut{
    std::string HeaderController::attachHeader(std::string &compressed_json,
                                               MessageType msg_type, MACAlgorithmType mac_algo_type, CompressionAlgorithmType compression_algo_type) {
        std::string header;
