...
{
public:
  static std::vector<uint8_t> generateHMAC(std::string &msg, std::vector<uint8_t> &key){
  ...
  static bool verifyHMAC(std::string &msg, std::vector<uint8_t> &hmac, std::vector<uint8_t> &key){
